 ...
 this.ckan.module('image-upload', function($) {
     return {
         ...
         initialize: function() {
             ...
             this.button_upload_cloud = $('<label for="file-upload-to-cloud" class="custom-file-upload">' +
                     '<i class="fa fa-cloud-upload"></i>' +
                     this._('Upload to cloud') + '</a>' +
                     '</label><input id="file-upload-to-cloud" type="file" onchange="uploadFile()" />')
                 .prop('title', this._('Upload data from local computer and send to the cloud'))
                 .insertAfter(this.input);

             // Button to set the field to be a URL
             this.button_url = $('<a href="javascript:;" class="btn btn-default" id="change"> ' +
